...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="/"><i class="menu-icon ti-desktop"></i>Dashboard</a>
                    </li>
                    <li class="menu-title">
                        Menu
                    </li>
                    <li>
                        <a href="{{ route('keuangan.index') }}"><i class="menu-icon ti-money"></i>Keuangan</a>
                    </li>
                    <li>
                        <a href="{{ route('customer.index') }}"><i class="menu-icon ti-user"></i>Customer</a>
                    </li>
                    <li>
                        <a href="{{ route('pembelian.index') }}"><i class="menu-icon ti-credit-card"></i>Pembelian</a>
                    </li>
                    <li>
                        <a href="{{ route('cicilan.index') }}"><i class="menu-icon ti-pulse"></i>Cicilan</a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            $('#detailCicilModal').on('show.bs.modal', function (e) {
                var button = $(e.relatedTarget)
                var id = button.data('isi')
                var nama = button.val();
                var no = 1;
